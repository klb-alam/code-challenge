...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate a random text file with alphanumeric strings.")
    parser.add_argument("filename", type=str, help="Name of the output file.")
    parser.add_argument("--max_size", type=int, default=10 * 1024 * 1024, help="Maximum size of the file in bytes (default: 10MB).")
    parser.add_argument("--max_lines", type=int, help="Maximum number of lines to write (default: unlimited).")
